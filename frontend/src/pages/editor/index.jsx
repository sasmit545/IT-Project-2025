...
function resize(e, isResizing, setLeftWidth, setRightWidth) {
    if (!isResizing.current) return;
    let mousePercentage = (e.clientX / window.innerWidth) * 100;

    if (isResizing.current === "left") {
        let newLeftWidth = mousePercentage;
        
        if (newLeftWidth > 30) newLeftWidth = 30; // Maximum width 30%
        setLeftWidth(newLeftWidth);
    } else if (isResizing.current === "right") {
        let newRightWidth = 100 - mousePercentage;
        
        if (newRightWidth > 25) newRightWidth = 25; // Maximum width 25%
...
export default function PageBuilder() {
    ...
    const handleMouseMove = (e) => resize(e, isResizing, setLeftWidth, setRightWidth);
    ...
    return (
        <DndContext onDragEnd={handleDragEnd}>
            ...
            <div className="heelo" style={{ margin:"0px",display: "flex", height: "100vh", position: "relative",width:"100%"  }}>

                {/* Left Sidebar */}
                <div style={{ width: `${leftWidth}%`, padding: "10px", borderRight: "2px solid gray", overflowY: "auto" }}>
                ...
                {/* Right Panel */}
                <div style={{ width: `${rightWidth}%`, padding: "10px", overflowY: "auto" }}>
