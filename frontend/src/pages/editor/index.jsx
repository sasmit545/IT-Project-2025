...
function NestedDroppable({
  ...
  const containerStyle = {
    ...
    border:
      ...
      (isOver ? "1px dashed #4CAF50" : "1px dashed #ccc"),
  };
...
function RenderComponent({
  ...
  if (ComponentType === "img") {
    return (
      <img
        src={component.src || "https://via.placeholder.com/300"}
...
function RightPanel({ selectedElement, setComponents, components }) {
  ...
  if (!selectedElement)
    return (
      <div
        style={{ width: "20%", padding: "10px", borderLeft: "2px solid gray" }}
      >
        <h3>Style Editor</h3>
  ...
  return (
    ...
    >
      ...
      <div style={{ marginBottom: "15px" }}>
        ...
        >
          Element Type:{" "}
          <span style={{ fontWeight: "normal" }}>{element?.type}</span>
        </label>
      </div>
        ...
        <div style={{ display: "flex", gap: "5px" }}>
          <button
            ...
            style={{
              flex: 1,
              background:
                element?.style?.textAlign === "left" ? "#ddd" : "#f5f5f5",
              padding: "5px",
              border: "1px solid #ccc",
            }}
          >
          ...
          <button
            ...
            style={{
              flex: 1,
              background:
                element?.style?.textAlign === "center" ? "#ddd" : "#f5f5f5",
              padding: "5px",
              border: "1px solid #ccc",
            }}
          >
          ...
          <button
            ...
            style={{
              flex: 1,
              background:
                element?.style?.textAlign === "right" ? "#ddd" : "#f5f5f5",
              padding: "5px",
              border: "1px solid #ccc",
            }}
          >
        ...
        <div style={{ display: "flex", gap: "5px" }}>
          <button
            ...
            style={{
              flex: 1,
              background:
                element?.style?.display === "block" ? "#ddd" : "#f5f5f5",
              padding: "5px",
              border: "1px solid #ccc",
            }}
          >
          ...
          <button
            ...
            style={{
              flex: 1,
              background:
                element?.style?.display === "inline" ? "#ddd" : "#f5f5f5",
              padding: "5px",
              border: "1px solid #ccc",
            }}
          >
          ...
          <button
            ...
            style={{
              flex: 1,
              background:
                element?.style?.display === "flex" ? "#ddd" : "#f5f5f5",
              padding: "5px",
              border: "1px solid #ccc",
            }}
          >
